package nl.globalorange.compliancewise.apigateway.filter;

import io.jsonwebtoken.Claims;
import io.jsonwebtoken.Jwts;
import nl.globalorange.compliancewise.apigateway.config.JwtConfiguration;
...
public class JwtTokenAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        try {
            ...
            // In case of failure make sure it's clear to guarantee user won't be authenticated
